...
public class SAXWeatherAdapter extends BaseAdapter {
	private Context context;
	private List<ForecastWeather> data = new ArrayList<ForecastWeather>();
	private LayoutInflater inflater;
	private Bitmap defaultBitmap;

	public SAXWeatherAdapter(Context context, List<ForecastWeather> data) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.adapter_sax_weather, null);
			item.img = (ImageView) convertView
					.findViewById(R.id.adapter_sax_weather_img);
			item.info = (TextView) convertView
					.findViewById(R.id.adapter_sax_weather_info);
