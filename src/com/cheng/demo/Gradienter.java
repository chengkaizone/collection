...
import com.cheng.widgets.GradienterView;

public class Gradienter extends CommonActivity implements SensorEventListener {
	// 定义水平仪的仪表盘
	GradienterView show;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 获取水平仪的主组件
		show = (GradienterView) findViewById(R.id.gradienter_show);
		// 获取真机的传感器管理服务
